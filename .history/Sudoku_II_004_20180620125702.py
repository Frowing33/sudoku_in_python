...
while True:  # prints Sudoku until is solved
    ...
    column2 = 0
       ...
       try:
        ...
        for item in sudoku1:
            column1 = column1 + int(item[0])
            column2 = column2 + int(item[1])
            column3 = column3 + int(item[2])
            column4 = column4 + int(item[3])
            column5 = column5 + int(item[4])
            column6 = column6 + int(item[5])
            column7 = column7 + int(item[6])
            column8 = column8 + int(item[7])
            column9 = column9 + int(item[8])
            column10 = column10 + int(item[9])
