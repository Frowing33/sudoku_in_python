...
r9=[[9,5, ' ', ' ', ' ', ' ', ' ', ' ',2],[6,5,9,1,2,4,7,8,' ']] # 9 1 6, 9 3 9, 9 4 1, 9 6 4, 9 8 8, 9 9 3
#r9=[[9,5, ' ', ' ', ' ', ' ', ' ', ' ',2],[' ',5,' ',' ',2,' ',7,' ',' ']] # 9 1 6, 9 3 9, 9 4 1, 9 6 4, 9 8 8, 9 9 3
...
print(" r - to load rodnom puzzle:")
print(" 1 - to load chart nr 1:")
print(" 2 - to load chart nr 4:")
...
while True: # prints Sudoku until is solved
    ...
    print("c - value")
    print("0 0 0 - reset chart do start\n ")
    x = input("Input a b c: ")
    print("")
